...
const Footer = () => {
  return (
    <footer className="font-primary bg-transparent mt-4 pb-28 bottom-0 text-white py-8 flex gap-8 justify-between flex-wrap p-8 shadow-[0px_-1px_16px_#222222] w-full">
      
      <div>
        <h2 className="text-white text-xl font-bold mb-4">About</h2>
        <p className="text-sm leading-relaxed">
          Melodies is a website that has been created for over
          <span className="text-primary font-medium"> 5 year's </span>
          ...
          <span className="text-primary font-medium"> premium pass’s.</span>
        </p>
      </div>
